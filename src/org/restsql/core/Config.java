...
public class Config {
	...
	public static final String DEFAULT_DATABASE_DAO = "org.restsql.core.impl.AbstractDAO";
	...
	public static final String DEFAULT_DATABASE_RESOURCES = "sakila";
	public static final String DEFAULT_DATABASE_SQL_ALL_RESOURCES = "SELECT 1";
	public static final String DEFAULT_DATABASE_SQL_RESOURCE_BYNAME = "SELECT 1";
	...
	public static final String KEY_DATABASE_DAO = "org.restsql.core.AbstractDAO";
	...
	public static final String KEY_DATABASE_RESOURCES = "database.resources";
	public static final String KEY_DATABASE_SQL_PING = "database.sql.ping";
	public static final String KEY_DATABASE_SQL_ALL_RESOURCES = "database.sql.allResources";
	public static final String KEY_DATABASE_SQL_RESOURCE_BYNAME = "database.sql.resourceByName";
